...
export class AgeCalculatorComponent implements OnInit, OnDestroy {
    ...
    GetAll_theFacts(_age_values) {
        ...
        this.FormatString_forEatAndDrink(this.facts);
    ...
    // 
    //#region GetEatAndDrinkValues(_eat_and_drink_in_hour)
    GetEatAndDrinkValues(_eat_and_drink_in_hour: number) {
        ...
        // 
        // Sleep in years, months, days, hours and minutes
        this.facts.eat_and_drink.years = _time_spent_in_eat_drink_time.years();
        this.facts.eat_and_drink.months = _time_spent_in_eat_drink_time.months();
        this.facts.eat_and_drink.days = _time_spent_in_eat_drink_time.days();
        this.facts.eat_and_drink.hours = _time_spent_in_eat_drink_time.hours();
        this.facts.eat_and_drink.minutes = _time_spent_in_eat_drink_time.minutes();
        // 
        // eat_and_drink in only months, weeks, days
        // 
        // _age_values.asMonths() % 1 will return the value after decimal point 
        // EX. 8.23045 = .23045
        // 
        this.facts.eat_and_drink.inOnly_months.months = Math.floor(_time_spent_in_eat_drink_time.asMonths());
        this.facts.eat_and_drink.inOnly_months.weeks = (_time_spent_in_eat_drink_time.asMonths() % 1) * 4.34524;
        // console.log(`in months [week]: ${this.facts.eat_and_drink.inOnly_months.weeks}`);
        this.facts.eat_and_drink.inOnly_months.days = Math.floor((this.facts.eat_and_drink.inOnly_months.weeks % 1) * 7);
        this.facts.eat_and_drink.inOnly_months.weeks = Math.floor(this.facts.eat_and_drink.inOnly_months.weeks);


        // 
        this.facts.eat_and_drink.inOnly_weeks.weeks = Math.floor(_time_spent_in_eat_drink_time.asWeeks());
        this.facts.eat_and_drink.inOnly_weeks.days = (_time_spent_in_eat_drink_time.asWeeks() % 1) * 7;
        this.facts.eat_and_drink.inOnly_weeks.hours = Math.floor((this.facts.eat_and_drink.inOnly_weeks.days % 1) * 24);
        this.facts.eat_and_drink.inOnly_weeks.days = Math.floor(this.facts.eat_and_drink.inOnly_weeks.days);

        // 
        this.facts.eat_and_drink.inOnly_days.days = Math.floor(_time_spent_in_eat_drink_time.asDays());
        this.facts.eat_and_drink.inOnly_days.hours = (_time_spent_in_eat_drink_time.asDays() % 1) * 24;
        this.facts.eat_and_drink.inOnly_days.minutes = Math.floor((this.facts.eat_and_drink.inOnly_days.hours % 1) * 60);
        this.facts.eat_and_drink.inOnly_days.hours = Math.floor(this.facts.eat_and_drink.inOnly_days.hours);
        // 
        this.facts.eat_and_drink.inOnly_hours.hours = Math.floor(_time_spent_in_eat_drink_time.asHours());
        this.facts.eat_and_drink.inOnly_hours.minutes = (_time_spent_in_eat_drink_time.asHours() % 1) * 60;
        this.facts.eat_and_drink.inOnly_hours.seconds = Math.floor((this.facts.eat_and_drink.inOnly_hours.minutes % 1) * 60);
        this.facts.eat_and_drink.inOnly_hours.minutes = Math.floor(this.facts.eat_and_drink.inOnly_hours.minutes);
        // 

        this.facts.eat_and_drink.inOnly_minutes.minutes = Math.floor(_time_spent_in_eat_drink_time.asMinutes());
        this.facts.eat_and_drink.inOnly_minutes.seconds = Math.floor((_time_spent_in_eat_drink_time.asMinutes() % 1) * 60);
    }
    // 
    //#region GetEatAndDrinkValues(_eat_and_drink_in_hour)
    // 
    ...
    // 
    //#region FormatString_forEatAndDrink(_facts)
    FormatString_forEatAndDrink(_facts) {
        this.facts_str_values.eat_and_drink.years = this.SingularOrPlural(_facts.eat_and_drink.years, 'year', 'years');
        this.facts_str_values.eat_and_drink.months = this.SingularOrPlural(_facts.eat_and_drink.months, 'month', 'months');
        this.facts_str_values.eat_and_drink.days = this.SingularOrPlural(_facts.eat_and_drink.days, 'day', 'days');
        this.facts_str_values.eat_and_drink.hours = this.SingularOrPlural(_facts.eat_and_drink.hours, 'hour', 'hours');
        this.facts_str_values.eat_and_drink.minutes = this.SingularOrPlural(_facts.eat_and_drink.minutes, 'minute', 'minutes');
        // 
        this.facts_str_values.eat_and_drink.inOnly_months.months = this.SingularOrPlural(_facts.eat_and_drink.inOnly_months.months, 'month', 'months');
        this.facts_str_values.eat_and_drink.inOnly_months.weeks = this.SingularOrPlural(_facts.eat_and_drink.inOnly_months.weeks, 'week', 'weeks');
        this.facts_str_values.eat_and_drink.inOnly_months.days = this.SingularOrPlural(_facts.eat_and_drink.inOnly_months.days, 'day', 'days');
        // 
        this.facts_str_values.eat_and_drink.inOnly_weeks.weeks = this.SingularOrPlural(_facts.eat_and_drink.inOnly_weeks.weeks, 'week', 'weeks');
        this.facts_str_values.eat_and_drink.inOnly_weeks.days = this.SingularOrPlural(_facts.eat_and_drink.inOnly_weeks.days, 'day', 'days');
        this.facts_str_values.eat_and_drink.inOnly_weeks.hours = this.SingularOrPlural(_facts.eat_and_drink.inOnly_weeks.hours, 'hour', 'hours');
        //
        this.facts_str_values.eat_and_drink.inOnly_days.days = this.SingularOrPlural(_facts.eat_and_drink.inOnly_days.days, 'day', 'days');
        this.facts_str_values.eat_and_drink.inOnly_days.hours = this.SingularOrPlural(_facts.eat_and_drink.inOnly_days.hours, 'hour', 'hours');
        this.facts_str_values.eat_and_drink.inOnly_days.minutes = this.SingularOrPlural(_facts.eat_and_drink.inOnly_days.minutes, 'minute', 'minutes');
        //
        this.facts_str_values.eat_and_drink.inOnly_hours.hours = this.SingularOrPlural(_facts.eat_and_drink.inOnly_hours.hours, 'hour', 'hours');
        this.facts_str_values.eat_and_drink.inOnly_hours.minutes = this.SingularOrPlural(_facts.eat_and_drink.inOnly_hours.minutes, 'minute', 'minutes');
        this.facts_str_values.eat_and_drink.inOnly_hours.seconds = this.SingularOrPlural(_facts.eat_and_drink.inOnly_hours.seconds, 'second', 'seconds');
        // 
        this.facts_str_values.eat_and_drink.inOnly_minutes.minutes = this.SingularOrPlural(_facts.eat_and_drink.inOnly_minutes.minutes, 'minute', 'minutes');
        this.facts_str_values.eat_and_drink.inOnly_minutes.seconds = this.SingularOrPlural(_facts.eat_and_drink.inOnly_minutes.seconds, 'second', 'seconds');
    }
    // 
    //#endregion FormatString_forEatAndDrink(_facts)
    // 
    ...
    FormatFacts_inText() {
        ...
        // 
        // 
        this.facts_in_text.eat_and_drink.time_spent_in_eat_and_drink = `${this.facts.eat_and_drink.years.toLocaleString()} ${this.facts_str_values.eat_and_drink.years} ${this.facts.eat_and_drink.months.toLocaleString()} ${this.facts_str_values.eat_and_drink.months} ${this.facts.eat_and_drink.days.toLocaleString()} ${this.facts_str_values.eat_and_drink.days} ${this.facts.eat_and_drink.hours} ${this.facts_str_values.eat_and_drink.hours} ${this.facts.eat_and_drink.minutes} ${this.facts_str_values.eat_and_drink.minutes}`;

        this.facts_in_text.eat_and_drink.inOnly_months = `${this.facts.eat_and_drink.inOnly_months.months.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_months.months} ${this.facts.eat_and_drink.inOnly_months.weeks.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_months.weeks} ${this.facts.eat_and_drink.inOnly_months.days.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_months.days}`;

        this.facts_in_text.eat_and_drink.inOnly_weeks = `${this.facts.eat_and_drink.inOnly_weeks.weeks.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_weeks.weeks} ${this.facts.eat_and_drink.inOnly_weeks.days.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_weeks.days} ${this.facts.eat_and_drink.inOnly_weeks.hours.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_weeks.hours}`;

        this.facts_in_text.eat_and_drink.inOnly_days = `${this.facts.eat_and_drink.inOnly_days.days.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_days.days} ${this.facts.eat_and_drink.inOnly_days.hours.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_days.hours} ${this.facts.eat_and_drink.inOnly_days.minutes.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_days.minutes}`;

        this.facts_in_text.eat_and_drink.inOnly_hours = `${this.facts.eat_and_drink.inOnly_hours.hours.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_hours.hours} ${this.facts.eat_and_drink.inOnly_hours.minutes.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_hours.minutes} ${this.facts.eat_and_drink.inOnly_hours.seconds.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_hours.seconds}`;

        this.facts_in_text.eat_and_drink.inOnly_minutes = `${this.facts.eat_and_drink.inOnly_minutes.minutes.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_minutes.minutes}  ${this.facts.eat_and_drink.inOnly_minutes.seconds.toLocaleString()} ${this.facts_str_values.eat_and_drink.inOnly_minutes.seconds}`;
    }
    // 
